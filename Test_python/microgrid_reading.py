...
def computing_fin_prob(l1, l11, relay):
        ...
        PFC1 = pfc_C1[0]*pCNN[0] + pfc_C2[0]*pCNN[1] + pfc_C3[0]*pCNN[2] 
                + pfc_C4[0]*pCNN[3]
        PFC2 = pfc_C1[1]*pCNN[0] + pfc_C2[1]*pCNN[1] + pfc_C3[1]*pCNN[2] 
                + pfc_C4[1]*pCNN[3]
        PFC3 = pfc_C1[2]*pCNN[0] + pfc_C2[2]*pCNN[1] + pfc_C3[2]*pCNN[2] 
                + pfc_C4[2]*pCNN[3]
        PFC = [PFC1, PFC2, PFC3]

        PF = pGP_C1*pCNN[0] + pGP_C2*pCNN[1] + pGP_C3*pCNN[2] 
                + pGP_C4*pCNN[3]
