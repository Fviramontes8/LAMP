...
"""
A helper function to read the .mat files in the Data/ folder.
Typically when the file is read, it is in the form of a dictionary with the
following keys:
...
Keyword arguments:
path -- A string describing the absolute or relative path to the .mat file.
